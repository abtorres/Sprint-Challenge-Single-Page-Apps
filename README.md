...
> Answer:
routing between views is faster because there is less data being
processed. transitions and animations are easier to implement.
- [ ] What does AJAX stand for?
> Answer:
Asynchronous JavaScript and XML.
- [ ] What are `controlled components` in React?
> Answer:
it is a n input form element whose value is controlled by React.
